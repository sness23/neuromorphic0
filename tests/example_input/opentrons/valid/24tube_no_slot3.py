...
# metadata
metadata = {
    "protocolName": "24tube Layout Missing Slot 3 Test",
    "author": "Test",
    "description": "Tests 24tube layout with optional slot 3 missing (slots 2, 4, 5, 6)"
}
...
def run(protocol: protocol_api.ProtocolContext):
    # load labware - 24TUBE WITHOUT SLOT 3: slots 2, 4, 5, 6
