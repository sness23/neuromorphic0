...
# metadata
metadata = {
    "protocolName": "Minimal 24tube Layout Test",
    "author": "Test",
    "description": "Tests minimal 24tube layout with only required slots 2 and 4"
}
...
def run(protocol: protocol_api.ProtocolContext):
    # load labware - MINIMAL 24TUBE: only slots 2 (output) and 4 (input rack 1)
