...
# metadata
metadata = {
    "protocolName": "24tube Layout Missing Slots 3 and 6 Test",
    "author": "Test",
    "description": "Tests 24tube layout with both optional slots missing (slots 2, 4, 5)"
}
...
def run(protocol: protocol_api.ProtocolContext):
    # load labware - 24TUBE WITHOUT SLOTS 3 AND 6: slots 2, 4, 5
