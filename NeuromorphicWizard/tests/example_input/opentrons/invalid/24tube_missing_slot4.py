...
# metadata
metadata = {
    "protocolName": "Invalid: 24tube Missing Required Slot 4 Test",
    "author": "Test",
    "description": "Tests invalid 24tube layout missing required slot 4 (input rack 1)"
}
...
def run(protocol: protocol_api.ProtocolContext):
    # load labware - INVALID: Has slots 5 and 6 but missing required slot 4
